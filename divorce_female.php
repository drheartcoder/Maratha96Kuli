...
/*$ggg = "SELECT * from bride where status='1'";
...
$end=30;
 ...
 $sqllimit="select * from bride where status='1' and marital_status = 'Divorcee'";
	$limittest=mysqli_query($con,$sqllimit);
    $rowlimit=mysqli_num_rows($limittest);   

    $sql="select * from bride where status='1' and marital_status = 'Divorcee' order by bride_id desc limit " .$start.",30";
                  ...
                  <td><table width="100%" border="0" cellpadding="3" cellspacing="3">
				   ...
				   ?>
                    <tr bgcolor="<?php echo $color;?>">
                      ...
                      <td><?php echo isset($result_1['working_As']);?></td>
                    </tr>
                    <?php $i++; } ?>
                  </table></td>
                </tr>
...
<?php
		...
		$pagination_new.=$prev_pagination.'<a href="divorce_female.php?first='.$count.'&last=30&slot='.$new_slot.'" class="bluelink">'.$k.'</a>&nbsp;&nbsp;';
		$prev_pagination="";
				...
				if($k%30==0)
				{
					...
					$next_pagination='<a href="divorce_female.php?first='.$count.'&last=30&slot='.$new_slot.'" class="bluelink">&gt;&gt;</a>&nbsp;&nbsp;';
					...
					$prev_pagination='<a href="divorce_female.php?first='.$ft .'&last=30&slot='. $lt .'" class="bluelink">&lt;&lt;</a>&nbsp;&nbsp;';
				}
			...
			for($m=0;$m<$x;$m++)
			 {
				...
				$pagination_new.='<a href="divorce_female.php?first='.$count.'&last=30&slot='.$new_slot.'" class="bluelink">'.$n .'</a>&nbsp;&nbsp;';
