...
$end=30;
 ...
 $sqllimit="select * from bridegroom where status='1' and marital_status = 'Widower' ";
	$limittest=mysqli_query($con,$sqllimit);
    $rowlimit=mysqli_num_rows($limittest);   

    $sql="select * from bridegroom where status='1' and marital_status='Widower' order by bridegroom_id desc limit " .$start.",30";
...
$mysearchresult = '<table cellspacing="3" cellpadding="3" border="0" width="600">';
			...
			if($i%2==0)
			 ...
			 $mysearchresult .= '<tr bgcolor= '. $color.' >
                        <td><a href="bridegroom_profille.php?id='.$ooo['bride_id'].'" target="_blank">' . $ooo['register_id'] . '</a></td>
...
<ul id="bx1">
	 ...
	 <form name="form1" id="rno" method="POST" action="">
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Search By The Registration Number:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="rno" type="text" id="rno" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type="submit" name="submit" size="25" value="Search" />
              ...
              <form id="form2" name="form2" method="post" action="">
                  ...
                  <tr>
                    <td><table width="100%" border="0" cellpadding="3" cellspacing="3">
                      <tr>
                        <td width="10%" height="23"><strong>Reg No</strong></td>
                        <td width="12%" align="center"><strong>Height</strong></td>
                      ...
                      <?php
					  while($result_1 = mysqli_fetch_array($agree_list))
				   {  
				   ...
				   ?>
                      <tr bgcolor="<?php echo $color;?>">
                        <td align="left"><a href="#" onclick="window.open('profille.php?id=<?php echo $result_1['bridegroom_id'];?>')"><?php echo $result_1['register_id'];?></a></td>
...
<?php
		...
		$pagination_new.=$prev_pagination.'<a href="widower.php?first='.$count.'&last=25&slot='.$new_slot.'" class="bluelink">'.$k.'</a>&nbsp;&nbsp;';
		$prev_pagination="";
				...
				if($k%30==0)
				{
					...
					$next_pagination='<a href="widower.php?first='.$count.'&last=30&slot='.$new_slot.'" class="bluelink">&gt;&gt;</a>&nbsp;&nbsp;';
					...
					$prev_pagination='<a href="widower.php?first='.$ft .'&last=30&slot='. $lt .'" class="bluelink">&lt;&lt;</a>&nbsp;&nbsp;';
				}
			...
			for($m=0;$m<$x;$m++)
			 {
				...
				$pagination_new.='<a href="widower.php?first='.$count.'&last=25&slot='.$new_slot.'" class="bluelink">'.$n .'</a>&nbsp;&nbsp;';
