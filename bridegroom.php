...
$end=30;
 ...
 $sqllimit="select * from bridegroom where status='1' and marital_status = 'Unmarried' ";
	$limittest=mysqli_query($con,$sqllimit);
    $rowlimit=mysqli_num_rows($limittest);   

    $sql="select * from bridegroom where status='1' and marital_status='Unmarried' order by bridegroom_id desc limit " .$start.",30";
        ...
        <div id="rht">
        	...
        	<div id="mid">
              ...
              <form id="form2" name="form2" method="post" action="">
                  ...
                  <tr>
                    <td align="center" bordercolor="#FF9900"><h3>Pages:<?php echo print_pages_new($rowlimit,$start,$end,$slot); ?></h3></td>
                  </tr>
                </table>
              </form>
              </div>     
...
<?php
		...
		$pagination_new.=isset($prev_pagination).'<a href="bridegroom.php?first='.$count.'&last=25&slot='.$new_slot.'" class="bluelink">'.$k.'</a>&nbsp;&nbsp;';
		$prev_pagination="";
