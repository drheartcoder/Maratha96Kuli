...
<tr> 
                <td colspan="2" bgcolor="#FFF0F0"><div align="center"><strong>Personal Details</strong></div></td>
                </tr>

<tr> 
                <td width="40%" bgcolor="#FFF0F0"><strong>First Name *</strong></td>

                <td width="60%"><?php echo $result_1['firstname'];?></td>
              </tr>
              <tr> 
                <td width="40%" bgcolor="#FFF0F0"><strong>Last Name *</strong></td>
                <td><?php echo $result_1['lastname'];?></td>
              </tr>
              <tr> 
              ...
              <tr> 
                ...
                <td><?php echo $result_1['income'];?></td>
              </tr>
              <tr> 
              ...
              <tr> 
                ...
                <td><?php echo $result_1['contact_lenses'];?></td>
              </tr>
              <tr> 
              ...
              <tr> 
                ...
                <td><?php echo $result_1['father'];?></td>
              </tr>
              <tr> 
              ...
              <tr> 
			   ...
			   <tr>
               <td bgcolor="#FFF0F0"><strong>Selected Package </strong></td>
				 
                  <td><?php echo $result_12['package_name']; ?> </td>
              </tr>
			  
			  
              <tr>
                <td bgcolor="#FFF0F0"><strong>Parent's Occupation</strong></td>
                <td><?php echo $result_1['parent_occupation'];?></td>
              </tr>
