    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffdcca">
              ...
              <tr> 
                <td>
                  <table width="101%" height="395" border="0" cellpadding="4" cellspacing="2">
                   <tr> 
                <td colspan="2" height="30px"><div align="center"><strong><font color="#FF0000">Personal Details</font></strong></div></td>
                    ...
                    <tr bgcolor="#FFF4F4"> 
                      ...
                      <td><strong>City :</strong>&nbsp;&nbsp;&nbsp;<?php echo $result_1['district'];?></td>
                    </tr>
                    <tr bgcolor="#FFF4F4"> 
                    ...
                    <tr bgcolor="#FFF4F4">
                      <td bgcolor="#FFF4F4"><strong>Complexion :</strong>&nbsp;&nbsp;&nbsp;<?php echo $result_1['complexion'];?></td>
                      <td></td>
                    </tr>
              ...
              <tr> 
				...
				<table width="102%" height="250" border="0" cellpadding="4" cellspacing="2">
					...
					<tr bgcolor="#FFF4F4"> 
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
                          <tr> 
                            <td><strong>Brothers Details :</strong>&nbsp;&nbsp;&nbsp;<?php echo $result_1['brother_details'];?></td>
                            
                          </tr>
                        </table></td>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
                          <tr> 
                            <td><strong>Sisters Details :</strong>&nbsp;&nbsp;&nbsp;<?php echo $result_1['sister_details'];?></td>
...
<!--			  Kundali Detail-->
			...
			<tr> 
			  ...
			  <tr>
			  <td valign="top">
			  <table width="101%" height="125" border="0" cellpadding="4" cellspacing="2">
                    
                
                   
                    <tr bgcolor="#FFF4F4">

                      <td width="51%" height="2" bgcolor="#FFF4F4"><strong>Mangal  :</strong>&nbsp;&nbsp;&nbsp;<?php echo $result_1['mangal'];?></td>
                      <td width="49%" height="2" bgcolor="#FFF4F4"><strong>Ras :</strong>&nbsp;&nbsp;&nbsp;<?php echo $result_1['ras'];?>&nbsp;&nbsp;&nbsp;<strong>Charan: </strong>&nbsp;&nbsp;&nbsp;<?php echo $result_1['charan'];?></td>
                    </tr>
                    <tr bgcolor="#FFF4F4">
              ...
              <tr> 
                <td valign="top"><table width="102%" height="250" border="0" cellpadding="4" cellspacing="2">
				<tr bgcolor="#FFF4F4"> 					
                    ...
                    <tr bgcolor="#FFF4F4"> 
                      <td><strong>Preferred Cities/District :</strong>&nbsp;&nbsp;&nbsp;<?php echo $result_1['exp_preferred_cities_district'];?></td>
                      <td></td>
                    </tr>
