...
if(isset($_POST['submit'])!="")
{
	...
	$cds = "INSERT into package(package_name,package_amount,package_status)VALUES(
	'".$_POST['package_name']."',
	'".$_POST['package_amount']."',
	'".$_POST['package_status']."'
	)";
	
	$cds_1 = mysqli_query($con,$cds);
	if(!$cds)
	{
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td>
						<table border="0" height="56" width="100%" cellpadding="0" cellspacing="0" align="center" >
							<tr bgcolor="#f3f3f3">	
								<td width="83%" height="40" align="center"><u><strong><font color="black" size="+1">Add Package </font></strong></u></td>
              ...
              <table width="100%" border="1" cellspacing="3" cellpadding="3">
                <tr>
                  ...
                  <td width="89%">
                    <label>
                      <input name="package_name" type="text" value="<?php echo $_POST['package_name'];?>" id="package_name" />
                      </label>
                ...
                <tr>
                  ...
                  <td>
                    <label>
                      <input name="package_amount" type="text" value="<?php echo $_POST['package_amount'];?>" id="package_amount" />
                      </label>
                ...
                <tr>
                  ...
                  <td>
                    <label>
                    <input name="package_status" type="radio" value="1" />
                    </label> 
                    Yes
                    <label>
                    <input name="package_status" type="radio" value="0" />
                    No</label></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
