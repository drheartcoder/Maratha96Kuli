...
<html>
    ...
    <body>
			<div class="content">
				...
				<form id="cropattrform" action="crop.php?id=<?php echo $_GET['id'];?>" method="post" onSubmit="return checkCoords();">
  		...
  		<script type="text/javascript">
	  		$(function() {
				$("#uploadify").uploadify({
					...
					'script'         : 'upload.php?id=<?php echo $result_1['id'];?>',
					...
					'fileDesc'		 : 'jpg',
					'fileExt'		 : '*.jpg',
					'sizeLimit'      : '3000000',//max size bytes - 800kb
