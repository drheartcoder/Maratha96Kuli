...
$end=10;
 ...
 $sqllimit="select * from bridegroom where marital_status='Unmarried'";
	$limittest=mysqli_query($con,$sqllimit);
    $rowlimit=mysqli_num_rows($limittest);   

    $sql="select * from bridegroom where marital_status='Unmarried' order by bridegroom_id desc limit " .$start.",10";
				...
				<tr>
					<td>
						<table border="0" height="56" width="100%" cellpadding="0" cellspacing="0" align="center" >
							<tr bgcolor="#f3f3f3">	
								<td width="83%" height="40" align="center"><u><strong><font color="black" size="+1">Groom</font></strong></u></td>
				...
				<tr>
					...
					else
					{
                      ...
                      <tr>
                        ...
                        <td align="center" class="normaltxt"><a href="bridegroom_details.php?id=<?php echo $result['bridegroom_id'];?>">Show Details</a></td>
                        <td align="center" class="normaltxt">
                          <label></label>
                          <strong></strong>
						  
                        <?php if( $result["status"]==0) { ?>
                        <b><a href="active.php?id=<?php echo $result['bridegroom_id'];?>">Active</a></b><? } else { ?><a href="inactive.php?id=<?php echo $result['bridegroom_id'];?>">Inactive</a><? } ?> </td>
                        <td align="center" class="normaltxt"><a href="groom_delete.php?id=<?php echo $result['bridegroom_id'];?>" class="bluelink"><img src="images/icon-recycle.gif"/ height="16" alt="" width="16" border="0" title="delete" /></a></td>
                      </tr>
                      <?php  $i++;}//while  
					}
				?>
