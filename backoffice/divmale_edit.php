...
<?php
	if(isset($_POST['Update'])!="")
	{
		...
		{				
			...
			{
				header("location:divorcee_male.php");
			}			
		}
	}

$cid=$_GET['id'];
$sql="select * from bridegroom where bridegroom_id=".$cid;
...
<a href="upload/index.php?id=<?php echo $result_1['bridegroom_id'];?>"> <input type="submit" name="sub" value="Upload Photo" onclick=""/></a></td>
                </tr>
