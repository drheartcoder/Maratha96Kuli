...
$end=25;
    ...
    $sql="select * from bride where marital_status='Divorcee' order by bride_id desc limit " .$start.",25";
				...
				<tr>
					<td>
						<table border="0" height="56" width="100%" cellpadding="0" cellspacing="0" align="center" >
							<tr bgcolor="#f3f3f3">	
								<td width="83%" height="40" align="center"><u><strong><font color="black" size="+1">Divorcee Female</font></strong></u></td>
				...
				<tr>
					...
					else
					{
                      ...
                      <tr>
                        ...
                        <td align="center" class="normaltxt"><a href="divfemale_details.php?id=<?php echo $result['bride_id'];?>">Show Details</a></td>
                        <td align="center" class="normaltxt"><a href="active_divfemale.php?id=<?php echo $result['bride_id'];?>">Active</a>||<a href="inactive_divfemale.php?id=<?php echo $result['bride_id'];?>">Inactive</a></td>
                        <td align="center" class="normaltxt"><a href="divfemale_delete.php?id=<?php echo $result['bride_id'];?>" class="bluelink"><img src="images/icon-recycle.gif"/ height="16" alt="" width="16" border="0" title="delete" /></a></td>
                      </tr>
                      <?php  $i++;}//while  
					}
				?>
