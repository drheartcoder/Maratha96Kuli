...
$end=10;
 ...
 $sqllimit="select * from bride where marital_status='Unmarried'";
	$limittest=mysqli_query($con,$sqllimit);
    $rowlimit=mysqli_num_rows($limittest);   


    $sql="select * from bride where marital_status='Unmarried' order by bride_id desc limit " .$start.",10";
				...
				<tr>
					<td>
						<table border="0" height="56" width="100%" cellpadding="0" cellspacing="0" align="center" >
							<tr bgcolor="#f3f3f3">	
								<td width="83%" height="40" align="center"><u><strong><font color="black" size="+1">Brides</font></strong></u></td>
				...
				<tr>
					<td><table width="100%" border="1" cellspacing="1" cellpadding="4" bordercolor="#999999" align="center">
                      <tr bgcolor="#ded9d9">
                        ...
                        <td width="10%" height="25" align="left" class="titletxt" style="padding-left:2px;"><strong>Name</strong></td>
                        <td width="8%" align="left" class="titletxt" style="padding-left:2px;"><strong>Address</strong></td>
                        <td width="7%" align="left" class="titletxt" style="padding-left:2px;"><strong>Phone</strong></td>
                        <td width="7%" align="left" class="titletxt" style="padding-left:2px;"><strong>Email</strong></td>
                        <td width="18%"  align="left" class="titletxt" style="padding-left:2px;"><strong> ShowDetails</strong></td>
                        <td width="14%"  align="center" class="titletxt"><strong>Status</strong></td>
                        <td width="11%"  align="center" class="titletxt"><strong>Delete</strong></td>
                      </tr>
                      <?php	
					...
					else
					{
                      ...
                      <tr>
                        ...
                        <td align="center" class="normaltxt"><a href="show_details.php?id=<?php echo $result['bride_id'];?>">Show Details</a></td>
                        <td align="center" class="normaltxt">
						<?php if( $result["status"]==0) { ?>
                        <b><a href="active1.php?id=<?php echo $result['bride_id'];?>">Active</a></b><? } else { ?><a href="inactive1.php?id=<?php echo $result['bride_id'];?>">Inactive</a><? } ?>
						
						
						</td>
                        <td align="center" class="normaltxt"><a href="delete.php?id=<?php echo $result['bride_id'];?>" class="bluelink"><img src="images/icon-recycle.gif"/ height="16" alt="" width="16" border="0" title="delete" /></a></td>
                      </tr>
                      <?php  $i++;}//while  
					}
				?>
...
<?php
		...
		$pagination_new.=$prev_pagination.'<a href="register.php?first='.$count.'&last=10&slot='.$new_slot.'" class="bluelink">'.$k.'</a>&nbsp;&nbsp;';
		$prev_pagination="";
				...
				if($k%10==0)
				{
					...
					$next_pagination='<a href="register.php?first='.$count.'&last=10&slot='.$new_slot.'" class="bluelink">&gt;&gt;</a>&nbsp;&nbsp;';
					...
					$prev_pagination='<a href="register.php?first='.$ft .'&last=10&slot='. $lt .'" class="bluelink">&lt;&lt;</a>&nbsp;&nbsp;';
				}
			...
			for($m=0;$m<$x;$m++)
			 {
				...
				$pagination_new.='<a href="register.php?first='.$count.'&last=10&slot='.$new_slot.'" class="bluelink">'.$n .'</a>&nbsp;&nbsp;';
