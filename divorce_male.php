...
$end=30;
 ...
 $sqllimit="select * from bridegroom where status='1' and marital_status = 'Divorcee' ";
    ...
    $sql="select * from bridegroom where status='1' and marital_status='Divorcee' order by bridegroom_id desc limit " .$start.",30";
...
<?php
		...
		$pagination_new.=$prev_pagination.'<a href="divorce_male.php?first='.$count.'&last=25&slot='.$new_slot.'" class="bluelink">'.$k.'</a>&nbsp;&nbsp;';
		$prev_pagination="";
				...
				if($k%30==0)
				{
					...
					$next_pagination='<a href="divorce_male.php?first='.$count.'&last=30&slot='.$new_slot.'" class="bluelink">&gt;&gt;</a>&nbsp;&nbsp;';
					...
					$prev_pagination='<a href="divorce_male.php?first='.$ft .'&last=30&slot='. $lt .'" class="bluelink">&lt;&lt;</a>&nbsp;&nbsp;';
				}
			...
			for($m=0;$m<$x;$m++)
			 {
				...
				$pagination_new.='<a href="divorce_male.php?first='.$count.'&last=30&slot='.$new_slot.'" class="bluelink">'.$n .'</a>&nbsp;&nbsp;';
